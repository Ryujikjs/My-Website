        ...
        <main className='bg-white px-20 font-body'>
          ...
          <section id="about" className='break-after-page pb-20'>
            ...
            <p>Please feel free to explore my portfolio to find out more about my projects and experiences below!</p>
              ...
              <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-full inline-flex items-center mx-4">
              ...
              <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-full inline-flex items-center mx-4">
                <a href="https://www.linkedin.com/in/ryuji-kow/" className='mx-9'>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-7 w-7"
                    fill="#0077b5"
