    ...
    <div>
      ...
      <div className='flex'>
        ...
        <nav className="pt-20 pr-16 h-screen sticky top-0">
          ...
          <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center mt-40 ">
            <a href="Ryuji Kow CV.pdf" alt="pdf">Resume PDF</a>
          </button>
          <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center mt-5">
            <a href="Ryuji's Projects.pdf" alt="projects pdf">Projects PDF</a>
          </button>
          <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center mt-5">
            <a href="https://github.com/Ryujikjs" className='mx-9'>
              <svg
          ...
          <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center mt-5">
            <a href="https://www.linkedin.com/in/ryuji-kow-224894227/" className='mx-9'>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-7 w-7"
                fill="#0077b5"
